...
namespace QFramework.ToolKits
{
    ...
    /// <summary>
    /// 普通单例创建类，通过反射创建ISingleton的实例，构造函数是非public
    /// </summary>
    ...
    /// <summary>
    /// 如果跳转到新的场景里已经有了实例，则删除已有实例，再创建新的实例
    /// </summary>
    /// <typeparam name="T"></typeparam>
